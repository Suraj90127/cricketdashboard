...
const UserPLByMarket = () => {
    ...
    // console.log("eventName", eventName, "id", id, "gameName", gameName)
                    ...
                    <div className="flex-1 bg-white p-4 rounded-lg">
                        ...
                        <div className="border border-gray-300 bg-white  text-[15px]">
                            <div className="bg-dark text-white py-1 px-3">
                                <h2 className="font-bold text-base">Profit & Loss Markets</h2>
                            </div>
                                            ...
                                            {!loading && PLdata?.length > 0 ? (
                                                PLdata.map((item, index) => (
                                                    <tr key={index} className="hover:bg-gray-100 text-center text-sm font-semibold">
                                                        ...
                                                        <td className="border border-gray-300 p-2 text-[#2789ce] cursor-pointer" onClick={() => navigate(`/userbethistory/${item.userName}`, { state: { gameName: item.gameName, eventName: item.eventName, marketName: item.marketName } })}>
                                                            {item.name}
                                                        </td>
                                                        <td className={`border border-gray-300 p-2 `}>
                                                            {Math.abs(item.betResult) || 0}
                                                        </td>
